...
map.getView().fit([8565835.034689, 947946.392381, 8566591.671030, 948664.070964], map.getSize());
...
var Title = new ol.control.Control({
    element: (() => {
        ...
        titleElement.innerHTML = '<h2 class="project-title">QGISWEB</h2>';
        return titleElement;
    })(),
    ...
    element: (() => {
        ...
        if (11 > 240) {
            ...
            window.showAbstract = function() {
                ...
                linkElement.innerHTML = 'new web map';
            }
